...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["teste_pagamento_____app_grid_sec_apps"]))
   {
      unset($_SESSION['session_sec_aplicacao']["teste_pagamento_____app_grid_sec_apps"]);
   }
