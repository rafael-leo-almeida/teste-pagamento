...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - sec_apps</TITLE>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_app_name_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['app_name'])) ? $this->New_label['app_name'] : "App Name "; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<INPUT  type="text" id="SC_app_name" name="app_name" value="<?php echo NM_encode_input($app_name) ?>"  size=50 alt="{datatype: 'text', maxLength: 128, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_app_type_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['app_type'])) ? $this->New_label['app_type'] : "App Type"; ?></TD>
     <TD class="scFilterFieldEven"> 
