...
<script type="text/javascript" src="app_grid_sec_apps_message.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - sec_apps</div>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_app_name_cond" name="app_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_app_name'), this, 'app_name')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_app_type_cond" name="app_type_cond" onChange="nm_campos_between(document.getElementById('id_vis_app_type'), this, 'app_type')">
       <OPTION value="eq" <?php if ("eq" == $app_type_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.app_name_cond.value = 'eq';
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "teste_pagamento/app_grid_sec_apps";
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['dyn_search']  = array(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_apps']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
