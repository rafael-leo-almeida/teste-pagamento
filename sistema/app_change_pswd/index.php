...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'], $this->root . $this->path_prod, 'teste_pagamento', 1, $this->force_db_utf8); 
      } 
      else 
      { 
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['app_change_pswd']['glo_nm_path_imag_temp'] . "/sc_apl_default_teste_pagamento.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_change_pswd']['glo_nm_path_imag_temp'] . "/sc_apl_default_teste_pagamento.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_teste_pagamento'])) {
                $_SESSION['scriptcase']['app_change_pswd']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_teste_pagamento'];
            }
        }
    }
