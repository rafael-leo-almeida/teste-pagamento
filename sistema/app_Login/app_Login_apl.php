...
else if($this->rs[0][0] == 'Y')
{
    ...
    if( $this->sc_temp_sett_enable_2fa == 'Y' && !empty($this->rs[0][3])){  if (isset($this->sc_temp_usr_login)) { $_SESSION['usr_login'] = $this->sc_temp_usr_login;}
...
$aLookup[] = array(app_Login_pack_protect_string('1') => str_replace('<', '&lt;',app_Login_pack_protect_string("Remember me")));
...
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('app_menu') . "/", $this->nm_location, "", "_self", "ret_self", 440, 630);
             ...
             $this->nm_mens_alert[] = $this->Ini->Nm_lang['lang_sec_usr_without_app']; $this->nm_params_alert[] = array(
                    ...
                    'position' => 'center',
                    'toast' => true
                    ); if ($this->NM_ajax_flag) { $this->sc_ajax_alert($this->Ini->Nm_lang['lang_sec_usr_without_app'], array(
                    'title' => $this->Ini->Nm_lang['lang_sec_2fa_error_title'],
                    'type' => 'error',
                    'timer' => '10000',
                    'showConfirmButton' => false,
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "Remember me?#?1?#?N?@?";
