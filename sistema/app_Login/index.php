...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'teste_pagamento', 1, $this->force_db_utf8); 
      } 
      else 
      { 
...
$this->sc_temp_sett_session_expire = '';
...
$this->sc_temp_sett_enable_2fa_expiration_time = '';
return;
...
;
        ...
        if(count($this->rs ) != 0 && $this->rs[0][0] == 'Y')
        {
            ...
            $this->sc_temp_usr_name		= $this->rs[0][1];
            $this->sc_temp_usr_email		= $this->rs[0][2];
...
;
		if ($export_permission == 'btn_display_on') {
    $_SESSION['scriptcase']['sc_apl_conf'][$this->rs->fields[0]]['btn_display']['json'] = 'on';
}
elseif ($export_permission == 'btn_display_off') {
    $_SESSION['scriptcase']['sc_apl_conf'][$this->rs->fields[0]]['btn_display']['json'] = 'off';
}
elseif ($export_permission == 'field_display_on') {
    $_SESSION['scriptcase']['sc_apl_conf'][$this->rs->fields[0]]['field_display']['json'] = 'on';
}
elseif ($export_permission == 'field_display_off') {
    $_SESSION['scriptcase']['sc_apl_conf'][$this->rs->fields[0]]['field_display']['json'] = 'off';
}
elseif ($export_permission == 'field_readonly') {
    $_SESSION['scriptcase']['sc_apl_conf'][$this->rs->fields[0]][$export_permission]['json'] = 'on';
}
else {
    $_SESSION['scriptcase']['sc_apl_conf'][$this->rs->fields[0]][$export_permission] = 'json';
}
;
...
$this->nmgp_redireciona_form($this->path_link . "" . SC_dir_app_name('app_menu') . "/", $this->nm_location, "", "_self", "ret_self", 440, 630);
             ...
             $this->nm_mens_alert[] = $this->Nm_lang['lang_sec_usr_without_app']; $this->nm_params_alert[] = array(
                    ...
                    'position' => 'center',
                    'toast' => true
                    ); if ($this->NM_ajax_flag) { $this->sc_ajax_alert($this->Nm_lang['lang_sec_usr_without_app'], array(
                    'title' => $this->Nm_lang['lang_sec_2fa_error_title'],
                    'type' => 'error',
                    'timer' => '10000',
                    'showConfirmButton' => false,
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['app_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_teste_pagamento.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_teste_pagamento.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_teste_pagamento'])) {
                $_SESSION['scriptcase']['app_Login']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_teste_pagamento'];
            }
        }
    }
