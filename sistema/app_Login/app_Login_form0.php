...
$remember_me_look = "";
 if ($this->remember_me == "1") { $remember_me_look .= "Remember me" ;} 
...
<?php  if (in_array("1", $this->remember_me_1))  { echo " checked" ;} ?> onClick="" ><label for="<?php echo $tempOptionId ?>">Remember me</label></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
 </TD>
   <?php }?>
