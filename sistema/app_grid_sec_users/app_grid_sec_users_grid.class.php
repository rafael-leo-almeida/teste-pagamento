...
// 
 ...
 function NM_grid_picture()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_picture_grid_line . "\"  style=\"" . $this->Css_Cmp['css_picture_grid_line'] . "\" NOWRAP align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_picture_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
