...
class app_grid_sec_users_det
{
 ...
 function monta_det()
 {
   ...
   { 
       $nmgp_select = "SELECT login, name, email, active, priv_admin, picture from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT login, name, email, active, priv_admin, picture from " . $this->Ini->nm_tabela; 
...
//--- 
   ...
   $conteudo_original = ''; 
          if (empty($this->picture) || $this->picture == "none") 
          { 
              $conteudo = "&nbsp;" ; 
              $out_picture = "" ; 
          } 
          ...
          { 
              ...
              elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != "pdf") 
              { 
                  $conteudo = "<a href=\"javascript:nm_mostra_img('" . $out1_picture . "', '$img_alt', '$img_larg')\"><img border=\"0\" src=\"$out_picture\"></a>"; 
              } 
              else 
              { 
   ...
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_picture_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("</TABLE>\r\n");
   if(isset($_SESSION['scriptcase']['proc_mobile']) && $_SESSION['scriptcase']['proc_mobile'])
