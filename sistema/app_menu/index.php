...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_transacao_usuario") . "/form_transacao_usuario_ini.txt"))
{
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("relatorio_transacao") . "/relatorio_transacao_ini.txt"))
{
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("app_search_sec_users") . "/app_search_sec_users_ini.txt"))
{
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[1]))
{
 ...
 $nm_var_hint[0] = "Fazer transferência";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[0]))
{
 ...
 $nm_var_hint[1] = "Meus recebimentos";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_11&sc_apl_menu=form_transacao_usuario&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_12&sc_apl_menu=relatorio_transacao&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=app_search_sec_users&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_10&sc_apl_menu=app_add_2fa&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
...
<div class="scMenuTHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scMenuTHeaderFont" style="float: left; text-transform: uppercase;"><?php echo "Sistema de pagamento" ?></div>
    <div class="scMenuTHeaderFont" style="float: right;margin-top: -8px;">
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['app_menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_teste_pagamento.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_teste_pagamento.txt"));
    }
    if (isset($apl_def)) {
        ...
        if (isset($_COOKIE['sc_actual_lang_teste_pagamento'])) {
            $_SESSION['scriptcase']['app_menu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_teste_pagamento'];
        }
    }
}
