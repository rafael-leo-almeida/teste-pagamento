      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
             ...
             { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('picture', 'login', 'pswd', 'confirm_pswd', 'name', 'email', 'active'), $aDoNotUpdate);
              $this->ajax_return_values();
...
sc_send_mail_api(array(
    'profile' => '',
		...
		'settings' => [
				...
				'smtp_port'     => '465',
				'smtp_user'     => 'vancouvertec@gmail.com',
				'smtp_password' => 'Vetec@2017',
				'from_email'    => 'vancouvertec@gmail.com',
				'from_name'    => 'vancouvertec@gmail.com',
		],
    'message' => [
