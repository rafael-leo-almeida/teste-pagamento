...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_app_form_edit_users_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_edit_users_submit_form(var_picture, var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_active, var_picture_ul_name, var_picture_ul_type, var_picture_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_edit_users_submit_form_cb);
