...
class treemenu_usuario_form_php
{
      var $sc_script_name;
      var $nm_location;
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['treemenu_usuario']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['treemenu_usuario']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['treemenu_usuario']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['treemenu_usuario']['sc_apl_link'];
...
<?php
    exit;
      ...
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['treemenu_usuario'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_transacao_usuario") . "/?nm_run_menu=1&nm_apl_menu=treemenu_usuario&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_2")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("relatorio_transacao") . "/?nm_run_menu=1&nm_apl_menu=treemenu_usuario&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_5")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("app_grid_sec_users") . "/?nm_run_menu=1&nm_apl_menu=treemenu_usuario&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_6")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("app_grid_sec_apps") . "/?nm_run_menu=1&nm_apl_menu=treemenu_usuario&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_7")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("app_search_sec_users") . "/?nm_run_menu=1&nm_apl_menu=treemenu_usuario&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_8")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("app_change_pswd") . "/?nm_run_menu=1&nm_apl_menu=treemenu_usuario&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_9")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("app_Login") . "/?nm_run_menu=1&nm_apl_menu=treemenu_usuario&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="treemenu_usuario"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "treemenu_usuario")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'treemenu_usuario', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
<?php
   ...
   function Gera_sc_init($apl_menu)
   {
        ...
        $this->menu_sc_init = $_SESSION['scriptcase']['treemenu_usuario']['sc_init'][$apl_menu];
...
$controle = new treemenu_usuario_form_php();
$controle->init();
?>
