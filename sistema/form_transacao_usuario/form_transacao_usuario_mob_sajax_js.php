  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_transacao_usuario_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_transacao_usuario_mob_form();
	}
...
?>
  ...
  function do_ajax_form_transacao_usuario_mob_validate_tipo_cliente()
  {
    var nomeCampo_tipo_cliente = "tipo_cliente";
    var var_tipo_cliente = scAjaxGetFieldSelect(nomeCampo_tipo_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transacao_usuario_mob_validate_tipo_cliente(var_tipo_cliente, var_script_case_init, do_ajax_form_transacao_usuario_mob_validate_tipo_cliente_cb);
  } // do_ajax_form_transacao_usuario_mob_validate_tipo_cliente

  function do_ajax_form_transacao_usuario_mob_validate_tipo_cliente_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transacao_usuario_mob_validate_tipo_cliente_cb

  // ---------- Validate login_usuario
  function do_ajax_form_transacao_usuario_mob_validate_login_usuario()
  {
    var nomeCampo_login_usuario = "login_usuario";
    var var_login_usuario = scAjaxGetFieldSelect(nomeCampo_login_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transacao_usuario_mob_validate_login_usuario(var_login_usuario, var_script_case_init, do_ajax_form_transacao_usuario_mob_validate_login_usuario_cb);
  } // do_ajax_form_transacao_usuario_mob_validate_login_usuario

  function do_ajax_form_transacao_usuario_mob_validate_login_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "login_usuario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transacao_usuario_mob_validate_login_usuario_cb

  // ---------- Validate cpf_cnpj
  function do_ajax_form_transacao_usuario_mob_validate_cpf_cnpj()
  {
    var nomeCampo_cpf_cnpj = "cpf_cnpj";
    var var_cpf_cnpj = scAjaxGetFieldText(nomeCampo_cpf_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transacao_usuario_mob_validate_cpf_cnpj(var_cpf_cnpj, var_script_case_init, do_ajax_form_transacao_usuario_mob_validate_cpf_cnpj_cb);
  } // do_ajax_form_transacao_usuario_mob_validate_cpf_cnpj

  function do_ajax_form_transacao_usuario_mob_validate_cpf_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transacao_usuario_mob_validate_cpf_cnpj_cb

  // ---------- Validate email
  function do_ajax_form_transacao_usuario_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transacao_usuario_mob_validate_email(var_email, var_script_case_init, do_ajax_form_transacao_usuario_mob_validate_email_cb);
  } // do_ajax_form_transacao_usuario_mob_validate_email

  function do_ajax_form_transacao_usuario_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transacao_usuario_mob_validate_email_cb

  // ---------- Validate senha
  function do_ajax_form_transacao_usuario_mob_validate_senha()
  {
    var nomeCampo_senha = "senha";
    var var_senha = scAjaxGetFieldText(nomeCampo_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transacao_usuario_mob_validate_senha(var_senha, var_script_case_init, do_ajax_form_transacao_usuario_mob_validate_senha_cb);
  } // do_ajax_form_transacao_usuario_mob_validate_senha

  function do_ajax_form_transacao_usuario_mob_validate_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "senha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transacao_usuario_mob_validate_senha_cb

  // ---------- Validate valor
  function do_ajax_form_transacao_usuario_mob_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transacao_usuario_mob_validate_valor(var_valor, var_script_case_init, do_ajax_form_transacao_usuario_mob_validate_valor_cb);
  } // do_ajax_form_transacao_usuario_mob_validate_valor

  function do_ajax_form_transacao_usuario_mob_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transacao_usuario_mob_validate_valor_cb

  // ---------- Validate status
  function do_ajax_form_transacao_usuario_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldText(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transacao_usuario_mob_validate_status(var_status, var_script_case_init, do_ajax_form_transacao_usuario_mob_validate_status_cb);
  } // do_ajax_form_transacao_usuario_mob_validate_status

  function do_ajax_form_transacao_usuario_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transacao_usuario_mob_validate_status_cb

  // ---------- Validate enviar_email
  function do_ajax_form_transacao_usuario_mob_validate_enviar_email()
  {
    var nomeCampo_enviar_email = "enviar_email";
    var var_enviar_email = scAjaxGetFieldText(nomeCampo_enviar_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transacao_usuario_mob_validate_enviar_email(var_enviar_email, var_script_case_init, do_ajax_form_transacao_usuario_mob_validate_enviar_email_cb);
  } // do_ajax_form_transacao_usuario_mob_validate_enviar_email

  function do_ajax_form_transacao_usuario_mob_validate_enviar_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "enviar_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transacao_usuario_mob_validate_enviar_email_cb

  // ---------- Validate payload
  function do_ajax_form_transacao_usuario_mob_validate_payload()
  {
    var nomeCampo_payload = "payload";
    var var_payload = scAjaxGetFieldText(nomeCampo_payload);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transacao_usuario_mob_validate_payload(var_payload, var_script_case_init, do_ajax_form_transacao_usuario_mob_validate_payload_cb);
  } // do_ajax_form_transacao_usuario_mob_validate_payload

  function do_ajax_form_transacao_usuario_mob_validate_payload_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "payload";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transacao_usuario_mob_validate_payload_cb

  // ---------- Event onfocus enviar_email
  function do_ajax_form_transacao_usuario_mob_event_enviar_email_onfocus()
  {
    var var_enviar_email = scAjaxGetFieldText("enviar_email");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_transacao_usuario_mob_event_enviar_email_onfocus(var_enviar_email, var_script_case_init, do_ajax_form_transacao_usuario_mob_event_enviar_email_onfocus_cb);
  } // do_ajax_form_transacao_usuario_mob_event_enviar_email_onfocus

  function do_ajax_form_transacao_usuario_mob_event_enviar_email_onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sFieldValid = "enviar_email";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_transacao_usuario_mob_event_enviar_email_onfocus_cb_after_alert);
  } // do_ajax_form_transacao_usuario_mob_event_enviar_email_onfocus_cb
  function do_ajax_form_transacao_usuario_mob_event_enviar_email_onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_transacao_usuario_mob_event_enviar_email_onfocus_cb_after_alert

  // ---------- Event onclick login_usuario
  function do_ajax_form_transacao_usuario_mob_event_login_usuario_onclick()
  {
    var var_login_usuario = scAjaxGetFieldSelect("login_usuario");
    var var_cpf_cnpj = scAjaxGetFieldText("cpf_cnpj");
    var var_email = scAjaxGetFieldText("email");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_transacao_usuario_mob_event_login_usuario_onclick(var_login_usuario, var_cpf_cnpj, var_email, var_script_case_init, do_ajax_form_transacao_usuario_mob_event_login_usuario_onclick_cb);
  } // do_ajax_form_transacao_usuario_mob_event_login_usuario_onclick

  function do_ajax_form_transacao_usuario_mob_event_login_usuario_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "login_usuario";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_transacao_usuario_mob_event_login_usuario_onclick_cb_after_alert);
  } // do_ajax_form_transacao_usuario_mob_event_login_usuario_onclick_cb
  function do_ajax_form_transacao_usuario_mob_event_login_usuario_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_transacao_usuario_mob_event_login_usuario_onclick_cb_after_alert

  // ---------- Event onfocus payload
  function do_ajax_form_transacao_usuario_mob_event_payload_onfocus()
  {
    var var_payload = scAjaxGetFieldText("payload");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_transacao_usuario_mob_event_payload_onfocus(var_payload, var_script_case_init, do_ajax_form_transacao_usuario_mob_event_payload_onfocus_cb);
  } // do_ajax_form_transacao_usuario_mob_event_payload_onfocus

  function do_ajax_form_transacao_usuario_mob_event_payload_onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sFieldValid = "payload";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_transacao_usuario_mob_event_payload_onfocus_cb_after_alert);
  } // do_ajax_form_transacao_usuario_mob_event_payload_onfocus_cb
  function do_ajax_form_transacao_usuario_mob_event_payload_onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_transacao_usuario_mob_event_payload_onfocus_cb_after_alert

  // ---------- Event onchange senha
  function do_ajax_form_transacao_usuario_mob_event_senha_onchange()
  {
    var var_senha = scAjaxGetFieldText("senha");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_transacao_usuario_mob_event_senha_onchange(var_senha, var_script_case_init, do_ajax_form_transacao_usuario_mob_event_senha_onchange_cb);
  } // do_ajax_form_transacao_usuario_mob_event_senha_onchange

  function do_ajax_form_transacao_usuario_mob_event_senha_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "senha";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_transacao_usuario_mob_event_senha_onchange_cb_after_alert);
  } // do_ajax_form_transacao_usuario_mob_event_senha_onchange_cb
  function do_ajax_form_transacao_usuario_mob_event_senha_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_transacao_usuario_mob_event_senha_onchange_cb_after_alert

  // ---------- Event onfocus status
  function do_ajax_form_transacao_usuario_mob_event_status_onfocus()
  {
    var var_status = scAjaxGetFieldText("status");
    var var_enviar_email = scAjaxGetFieldText("enviar_email");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_transacao_usuario_mob_event_status_onfocus(var_status, var_enviar_email, var_script_case_init, do_ajax_form_transacao_usuario_mob_event_status_onfocus_cb);
  } // do_ajax_form_transacao_usuario_mob_event_status_onfocus

  function do_ajax_form_transacao_usuario_mob_event_status_onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sFieldValid = "status";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_transacao_usuario_mob_event_status_onfocus_cb_after_alert);
  } // do_ajax_form_transacao_usuario_mob_event_status_onfocus_cb
  function do_ajax_form_transacao_usuario_mob_event_status_onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_transacao_usuario_mob_event_status_onfocus_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_transacao_usuario_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_transacao_usuario_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tipo_cliente = scAjaxGetFieldSelect("tipo_cliente");
    var var_login_usuario = scAjaxGetFieldSelect("login_usuario");
    var var_cpf_cnpj = scAjaxGetFieldText("cpf_cnpj");
    var var_email = scAjaxGetFieldText("email");
    var var_senha = scAjaxGetFieldText("senha");
    ...
    var var_enviar_email = scAjaxGetFieldText("enviar_email");
    var var_payload = scAjaxGetFieldText("payload");
    var var_id_transacao = scAjaxGetFieldText("id_transacao");
    ...
    scAjaxProcOn();
    x_ajax_form_transacao_usuario_mob_submit_form(var_tipo_cliente, var_login_usuario, var_cpf_cnpj, var_email, var_senha, var_valor, var_status, var_enviar_email, var_payload, var_id_transacao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_transacao_usuario_mob_submit_form_cb);
  } // do_ajax_form_transacao_usuario_mob_submit_form

  function do_ajax_form_transacao_usuario_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("login_usuario");
      ...
      scAjaxHideErrorDisplay("enviar_email");
      scAjaxHideErrorDisplay("payload");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_transacao_usuario_mob_submit_form_cb_after_alert);
  } // do_ajax_form_transacao_usuario_mob_submit_form_cb
  function do_ajax_form_transacao_usuario_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_transacao_usuario_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_transacao_usuario_mob_navigate_form()
  {
    perform_ajax_form_transacao_usuario_mob_navigate_form();
  }

  function perform_ajax_form_transacao_usuario_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("enviar_email");
    scAjaxHideErrorDisplay("payload");
    var var_id_transacao = document.F2.id_transacao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_transacao_usuario_mob_navigate_form(var_id_transacao, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_transacao_usuario_mob_navigate_form_cb);
  } // do_ajax_form_transacao_usuario_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_transacao_usuario_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_transacao_usuario_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_transacao.value = scAjaxGetKeyValue("id_transacao");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_transacao_usuario_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_transacao_usuario_mob_navigate_form_cb
  function do_ajax_form_transacao_usuario_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_transacao_usuario_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_transacao_usuario_mob_navigate_form_cb_after_alert
  function sc_hide_form_transacao_usuario_mob_form()
  {
  ...
  ajax_field_list[0] = "tipo_cliente";
  ajax_field_list[1] = "login_usuario";
  ajax_field_list[2] = "cpf_cnpj";
  ajax_field_list[3] = "email";
  ajax_field_list[4] = "senha";
  ajax_field_list[5] = "valor";
  ajax_field_list[6] = "status";
  ajax_field_list[7] = "enviar_email";
  ajax_field_list[8] = "payload";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "tipo_cliente": {"label": "<?php echo $this->Ini->Nm_lang['lang_tbl_transacao_fld_tipo_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "login_usuario": {"label": "<?php echo $this->Ini->Nm_lang['lang_tbl_transacao_fld_login_usuario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cpf_cnpj": {"label": "<?php echo $this->Ini->Nm_lang['lang_tbl_transacao_fld_cpf_cnpj'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "email": {"label": "<?php echo $this->Ini->Nm_lang['lang_tbl_transacao_fld_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "senha": {"label": "<?php echo $this->Ini->Nm_lang['lang_tbl_transacao_fld_senha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "valor": {"label": "<?php echo $this->Ini->Nm_lang['lang_tbl_transacao_fld_valor'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "status": {"label": "<?php echo $this->Ini->Nm_lang['lang_tbl_transacao_fld_status'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "enviar_email": {"label": "<?php echo $this->Ini->Nm_lang['lang_tbl_transacao_fld_enviar_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "payload": {"label": "<?php echo $this->Ini->Nm_lang['lang_tbl_transacao_fld_payload'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "login_usuario": new Array(),
    "cpf_cnpj": new Array(),
    "email": new Array(),
    "senha": new Array(),
    "valor": new Array(),
    "status": new Array(),
    "enviar_email": new Array(),
    "payload": new Array()
  };
  ajax_field_mult["tipo_cliente"][1] = "tipo_cliente";
  ajax_field_mult["login_usuario"][1] = "login_usuario";
  ...
  ajax_field_mult["enviar_email"][1] = "enviar_email";
  ajax_field_mult["payload"][1] = "payload";

  var ajax_field_id = {
    "tipo_cliente": new Array("hidden_field_label_tipo_cliente", "hidden_field_data_tipo_cliente"),
    "login_usuario": new Array("hidden_field_label_login_usuario", "hidden_field_data_login_usuario"),
    ...
    "enviar_email": new Array("hidden_field_label_enviar_email", "hidden_field_data_enviar_email"),
    "payload": new Array("hidden_field_label_payload", "hidden_field_data_payload")
  };
