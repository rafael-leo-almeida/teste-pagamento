<?php
@session_start() ;
$_SESSION['scriptcase']['relatorio_transacao']['sc_process_barr'] = true;
require_once('../relatorio_transacao/index.php');
unset($_SESSION['scriptcase']['relatorio_transacao']['sc_process_barr']);
$ExportCtrl = new relatorio_transacao_export_control;
$ExportCtrl->Export_barr();

class relatorio_transacao_export_control
{
