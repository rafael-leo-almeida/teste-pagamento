<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['relatorio_transacao']['glo_nm_path_imag_temp'] . "/sc_apl_default_teste_pagamento.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new relatorio_transacao_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class relatorio_transacao_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["tipo_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["tipo_cliente"])) ? $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["tipo_cliente"] : "" . $this->Nm_lang['lang_tbl_transacao_fld_tipo_cliente'] . "";
   $tab_ger_campos['login_usuario'] = "on";
   $tab_def_campos['login_usuario'] = "login_usuario";
   $tab_labels["login_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["login_usuario"])) ? $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["login_usuario"] : "" . $this->Nm_lang['lang_tbl_transacao_fld_login_usuario'] . "";
   $tab_ger_campos['cpf_cnpj'] = "on";
   $tab_def_campos['cpf_cnpj'] = "cpf_cnpj";
   $tab_labels["cpf_cnpj"]   = (isset($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["cpf_cnpj"])) ? $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["cpf_cnpj"] : "" . $this->Nm_lang['lang_tbl_transacao_fld_cpf_cnpj'] . "";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["email"] : "" . $this->Nm_lang['lang_tbl_transacao_fld_email'] . "";
   $tab_ger_campos['senha'] = "on";
   $tab_def_campos['senha'] = "senha";
   $tab_labels["senha"]   = (isset($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["senha"])) ? $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["senha"] : "" . $this->Nm_lang['lang_tbl_transacao_fld_senha'] . "";
   $tab_ger_campos['enviar_email'] = "on";
   $tab_def_campos['enviar_email'] = "enviar_email";
   $tab_labels["enviar_email"]   = (isset($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["enviar_email"])) ? $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["enviar_email"] : "" . $this->Nm_lang['lang_tbl_transacao_fld_enviar_email'] . "";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["valor"] : "" . $this->Nm_lang['lang_tbl_transacao_fld_valor'] . "";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["status"] : "" . $this->Nm_lang['lang_tbl_transacao_fld_status'] . "";
   $tab_ger_campos['payload'] = "on";
   $tab_def_campos['payload'] = "payload";
   $tab_labels["payload"]   = (isset($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["payload"])) ? $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['labels']["payload"] : "" . $this->Nm_lang['lang_tbl_transacao_fld_payload'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> tbl_transacao</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "relatorio_transacao_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['relatorio_transacao']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['relatorio_transacao']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
