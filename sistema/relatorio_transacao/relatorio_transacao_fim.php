...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["teste_pagamento_____relatorio_transacao"]))
   {
      unset($_SESSION['session_sec_aplicacao']["teste_pagamento_____relatorio_transacao"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['relatorio_transacao']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['relatorio_transacao']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['relatorio_transacao']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['relatorio_transacao']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['relatorio_transacao']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>relatorio_transacao</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['relatorio_transacao']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['relatorio_transacao']['embutida_filho'] as $ind => $sc_init)
          {
