...
class app_grid_sec_users_apps_rtf
{
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['rtf_name'] .= ".rtf";
          }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_list_apps_x_users'] ?> :: RTF</TITLE>
