...
class app_grid_sec_users_apps_csv
{
   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['csv_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['csv_name'] .= ".csv";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['csv_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['csv_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['csv_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['csv_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_list_apps_x_users'] ?> :: CSV</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['csv_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
