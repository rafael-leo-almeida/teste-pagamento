...
if (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['app_grid_sec_users_apps']['app_grid_sec_users_apps_iframe_params']))
{
    ...
    $str_google_fonts   = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['app_grid_sec_users_apps']['app_grid_sec_users_apps_iframe_params']['str_google_fonts'];
}
if (isset($aParams['sc_create_charts'])) {
    $_SESSION['sc_session'][ $aParams['script_case_init'] ]['app_grid_sec_users_apps']['skip_charts'] = 'N' == $aParams['sc_create_charts'];
}
if (isset($aParams['chart_level'])) {
    $_SESSION['sc_session'][ $aParams['script_case_init'] ]['app_grid_sec_users_apps']['chart_level'] = $aParams['chart_level'];
}
elseif (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['app_grid_sec_users_apps']['chart_level'])) {
    unset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['app_grid_sec_users_apps']['chart_level']);
}
if (isset($aParams['page_break_pdf']) && $aParams['page_break_pdf'] != "_NO_")
{
    $Arr_page_pdf = explode("_BRK_", $aParams['page_break_pdf']);
    foreach ($_SESSION['sc_session'][$aParams['script_case_init']]['app_grid_sec_users_apps']['Page_break_PDF'] as $cmp => $opt)
    {
        if (in_array($cmp, $Arr_page_pdf))
        {
            $_SESSION['sc_session'][$aParams['script_case_init']]['app_grid_sec_users_apps']['Page_break_PDF'][$cmp] = "S";
        }
        else
        {
            $_SESSION['sc_session'][$aParams['script_case_init']]['app_grid_sec_users_apps']['Page_break_PDF'][$cmp] = "N";
        }
    }
}
$_SESSION['sc_session'][$aParams['script_case_init']]['app_grid_sec_users_apps']['opc_pdf']['all_cab']     = (isset($aParams['pdf_all_cab']))     ? $aParams['pdf_all_cab']     : "N";
$_SESSION['sc_session'][$aParams['script_case_init']]['app_grid_sec_users_apps']['opc_pdf']['all_label']   = (isset($aParams['pdf_all_label']))   ? $aParams['pdf_all_label']   : "N";
$_SESSION['sc_session'][$aParams['script_case_init']]['app_grid_sec_users_apps']['opc_pdf']['label_group'] = (isset($aParams['pdf_label_group'])) ? $aParams['pdf_label_group'] : "S";
$_SESSION['sc_session'][$aParams['script_case_init']]['app_grid_sec_users_apps']['opc_pdf']['pdf_zip']     = (isset($aParams['pdf_zip']))         ? $aParams['pdf_zip']         : "N";
$Nm_lang     = array();
...
<head>
 <title><?php echo $Nm_lang['lang_list_apps_x_users'] ?> :: PDF</title>
...
<?php
if (isset($_SESSION['sc_session'][$aParams['script_case_init']]['app_grid_sec_users_apps']['pdf_name'])) {
    $Pos = strrpos($_SESSION['sc_session'][$aParams['script_case_init']]['app_grid_sec_users_apps']['pdf_name'], ".");
    if ($Pos === false) {
        $_SESSION['sc_session'][$aParams['script_case_init']]['app_grid_sec_users_apps']['pdf_name'] .= ".pdf";
    }
}
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['app_grid_sec_users_apps']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['app_grid_sec_users_apps']['pdf_name'] : 'sc_pdf_' . md5(date('Ymd') . '_' . session_id()) . '_app_grid_sec_users_apps.pdf';
...
if (isset($_SESSION['sc_session'][$aParams['script_case_init']]['app_grid_sec_users_apps']['opc_pdf']['pdf_zip']) && $_SESSION['sc_session'][$aParams['script_case_init']]['app_grid_sec_users_apps']['opc_pdf']['pdf_zip'] == "S")
 {
...
$_SESSION['sc_session'][$aParams['script_case_init']]['app_grid_sec_users_apps'][$path_doc_md5][0] = $_SESSION['scriptcase']['app_grid_sec_users_apps']['glo_nm_path_imag_temp'] . "/" . $NM_tit_doc;
