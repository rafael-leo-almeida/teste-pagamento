...
<script type="text/javascript" src="app_grid_sec_users_apps_message.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_list_apps_x_users'] ?></div>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_priv_access_cond" name="priv_access_cond" onChange="nm_campos_between(document.getElementById('id_vis_priv_access'), this, 'priv_access')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_priv_insert_cond" name="priv_insert_cond" onChange="nm_campos_between(document.getElementById('id_vis_priv_insert'), this, 'priv_insert')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_priv_delete_cond" name="priv_delete_cond" onChange="nm_campos_between(document.getElementById('id_vis_priv_delete'), this, 'priv_delete')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_priv_update_cond" name="priv_update_cond" onChange="nm_campos_between(document.getElementById('id_vis_priv_update'), this, 'priv_update')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_priv_export_cond" name="priv_export_cond" onChange="nm_campos_between(document.getElementById('id_vis_priv_export'), this, 'priv_export')">
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.priv_access_cond.value = 'eq';
   ...
   document.F1.priv_insert_cond.value = 'eq';
   ...
   document.F1.priv_delete_cond.value = 'eq';
   ...
   document.F1.priv_update_cond.value = 'eq';
   ...
   document.F1.priv_export_cond.value = 'eq';
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "teste_pagamento/app_grid_sec_users_apps";
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['dyn_search']  = array(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_apps']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
