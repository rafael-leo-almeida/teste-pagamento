<?php
@session_start() ;
$_SESSION['scriptcase']['app_grid_sec_users_apps']['sc_process_barr'] = true;
require_once('../app_grid_sec_users_apps/index.php');
unset($_SESSION['scriptcase']['app_grid_sec_users_apps']['sc_process_barr']);
$ExportCtrl = new app_grid_sec_users_apps_export_control;
$ExportCtrl->Export_barr();

class app_grid_sec_users_apps_export_control
{
