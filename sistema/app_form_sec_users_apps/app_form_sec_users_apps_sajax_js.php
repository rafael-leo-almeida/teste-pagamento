...
?>
  ...
  function do_ajax_app_form_sec_users_apps_table_refresh_cb(sResp)
  {
    ...
    scAjaxAlert(do_ajax_app_form_sec_users_apps_table_refresh_cb_after_alert);
  } // do_ajax_app_form_sec_users_apps_table_refresh_cb
  function do_ajax_app_form_sec_users_apps_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_app_form_sec_users_apps_table_refresh_cb_after_alert
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_app_form_sec_users_apps_submit_form_cb_after_alert);
  } // do_ajax_app_form_sec_users_apps_submit_form_cb
  function do_ajax_app_form_sec_users_apps_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_app_form_sec_users_apps_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_app_form_sec_users_apps_navigate_form()
  {
    perform_ajax_app_form_sec_users_apps_navigate_form();
  }

  function perform_ajax_app_form_sec_users_apps_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_app_form_sec_users_apps_navigate_form_cb(sResp)
  {
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_app_form_sec_users_apps_navigate_form_cb_after_alert);
  } // do_ajax_app_form_sec_users_apps_navigate_form_cb
  function do_ajax_app_form_sec_users_apps_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_app_form_sec_users_apps_navigate_form_cb_after_alert
