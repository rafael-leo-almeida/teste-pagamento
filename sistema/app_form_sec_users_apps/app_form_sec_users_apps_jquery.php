...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_login_' + iSeqRow).bind('change', function() { sc_app_form_sec_users_apps_login__onchange(this, iSeqRow) });
...
function sc_app_form_sec_users_apps_login__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_app_form_sec_users_apps_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'app_form_sec_users_apps')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
