...
<script type="text/javascript" src="app_search_sec_users_message.js"></script>
...
if (count($this->nm_mens_alert) || count($this->Ini->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_users']['ajax_nav'])
           { 
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_users']['dashboard_info']['compact_mode'])
      {
          return;
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_login_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['login'])) ? $this->New_label['login'] : "Login"; ?></TD>
...
<?php
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_users']['psq_check_ret']['login'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_users']['dyn_search']  = array(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_users']['campos_busca'] = $Temp_Busca;
      }
      $login_LKP = $login;
      $Tmp_pos = strpos($login, "##@@");
      if ($Tmp_pos !== false)
...
$_SESSION['scriptcase']['app_search_sec_users']['contr_erro'] = 'off'; 
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_users_apps']['where_filter'] = $this->comando_filtro;
      $this->retorna_pesq();
   }
