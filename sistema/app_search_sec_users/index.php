<?php
   ...
   $_SESSION['scriptcase']['app_search_sec_users']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['app_search_sec_users']['glo_nm_path_doc']        = "";
    ...
    //check cache
    if(empty($_SESSION['scriptcase']['app_search_sec_users']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['app_search_sec_users']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
...
// 
      ...
      $this->path_cache  = $_SESSION['scriptcase']['app_search_sec_users']['glo_nm_path_cache'];
      ...
      if (!isset($_SESSION['scriptcase']['app_search_sec_users']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['app_search_sec_users']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['app_search_sec_users']['save_session']['data'] = '';
      } 
      ...
      $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['app_search_sec_users']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['app_search_sec_users']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['app_search_sec_users']['actual_lang']) || $_SESSION['scriptcase']['app_search_sec_users']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['app_search_sec_users']['actual_lang'] = $this->str_lang;
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      ...
      $this->sc_lig_target["A_@scinf__@scinf_app_form_sec_users_apps"] = '';
      if ($_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["app_search_sec_users"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["app_search_sec_users"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['app_search_sec_users']['session_timeout']['redir']))
      {
...
// 
      ...
      if (isset($_SESSION['scriptcase']['app_search_sec_users']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['app_search_sec_users']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['app_search_sec_users']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['app_search_sec_users']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['app_search_sec_users']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['app_search_sec_users']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_search_sec_users']['glo_nm_conexao'], $this->root . $this->path_prod, 'teste_pagamento', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['app_search_sec_users']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
   ...
   function controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_users']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_users']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_search_sec_users']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_search_sec_users']['label'] = "" . $this->Ini->Nm_lang['lang_list_users'] . "";
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_search_sec_users']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_search_sec_users']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_search_sec_users']['glo_nm_conexao'], $this->Ini->root . $this->Ini->path_prod, 'teste_pagamento', 1, $this->Ini->force_db_utf8); 
      } 
      else 
      { 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_search_sec_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_teste_pagamento.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_search_sec_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_teste_pagamento.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "app_search_sec_users") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['app_search_sec_users']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['app_search_sec_users']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['app_search_sec_users']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_teste_pagamento'])) {
               $_SESSION['scriptcase']['app_search_sec_users']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_teste_pagamento'];
           }
       }
   }
   if (isset($login)) 
   ...
   if (isset($_SESSION['scriptcase']['app_search_sec_users']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['app_search_sec_users']['session_timeout']['lang'];
   }
   ...
   { 
       ...
       elseif (substr($_SESSION['sc_session'][$script_case_init]['app_search_sec_users']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['app_search_sec_users']['opcao'] != "pdf" ) 
       {
           ...
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['app_search_sec_users']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['app_search_sec_users']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['app_search_sec_users']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       ...
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['app_search_sec_users']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['app_search_sec_users']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['app_search_sec_users']['opc_psq'] && !isset($_SESSION['scriptcase']['app_search_sec_users']['session_timeout']['redir'])) 
       { 
